...
public class Task { 
    ...
    //引数ありのコンストラクタ 
    public Task(String title, LocalDate deadline, LocalTime time, DateType dateType,String description){   
    ...
    public Task(String title, LocalDate deadline, LocalTime time, DateType dateType, boolean completed, String description){ 
        this.title = title;  
